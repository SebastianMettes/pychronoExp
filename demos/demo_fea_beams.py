...
builder.BuildBeam(my_mesh,                   # the mesh where to put the created nodes and elements
                    ...
                    50,                         # the number of ChElementBeamEuler to create
...
builder.BuildBeam(my_mesh, msection, 50,
...
while(my_system.GetChTime() < 0.8):
    #s = time.perf_counter()
    #This is maybe equivalent to myapp.DoStep()
    my_system.DoStepDynamics(0.05)
