...
arm3 = sim.Motor_arm(motor_system.system,False,pla(),0.025,0.0125,(0,0,0),(0,0,1),0.000,10) #create arm in simulation
arm4 = sim.Motor_arm(motor_system.system,False,pla(),0.025,0.0125,(0,0,1),(0,0,1.5),0.000,10,origin=False,stator_constraint=arm3.arm_tip)#create attached second arm
arm5 = sim.Motor_arm(motor_system.system,False,pla(),0.025,0.0125,(0,0,0),(0,0,1),0.000,10) #create arm in simulation
arm6 = sim.Motor_arm(motor_system.system,False,pla(),0.025,0.0125,(0,0,1),(0,0,1.5),0.000,10,origin=False,stator_constraint=arm5.arm_tip)#create attached second arm
arm7 = sim.Motor_arm(motor_system.system,False,pla(),0.025,0.0125,(0,0,0),(0,0,1),0.000,10) #create arm in simulation
arm8 = sim.Motor_arm(motor_system.system,False,pla(),0.025,0.0125,(0,0,1),(0,0,1.5),0.000,10,origin=False,stator_constraint=arm7.arm_tip)#create attached second arm
...
while(motor_system.system.GetChTime()<maxtime):
    if not headless:
        ...
        arm3.set_torque(float(m1t)) #Apply torque
        arm4.set_torque(float(m2t))
        arm5.set_torque(float(m1t)) #Apply torque
        arm6.set_torque(float(m2t))
        arm7.set_torque(float(m1t)) #Apply torque
        arm8.set_torque(float(m2t))
